...
public:
    ...
    void handleEvents(Player* player, const sf::Event& event) override;
    void startFalling(Player* player) override;
    void hitGround(Player* player) override;
    void hook(Player* player) override;
};
class FirstAttack : public PlayerState {
public:
    FirstAttack(Player* player, float initialVelocity);
    void update(Player* player, float dt) override;
    void handleEvents(Player* player, const sf::Event& event) override;
    void startFalling(Player* player) override;
    void hitGround(Player* player) override;
